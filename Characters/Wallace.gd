...
func _ready():
	States = {
		...
		"delta":0,
		"IDLE": [
			["Idle",    8.0/60.0,  0, "IDLE",             1, [  0,  0], [  0,  0], "CantBeHit",  0.0, 0],
			["Idle",    8.0/60.0,  1, "IDLE",             2, [  0,  0], [  0,  0], "CantBeHit",  0.0, 0],
			["Idle",    8.0/60.0,  2, "IDLE",             3, [  0,  0], [  0,  0], "CantBeHit",  0.0, 0],
			["Idle",    8.0/60.0,  3, "",                 0, [  0,  0], [  0,  0], "CantBeHit",  0.0, 0],
		],
		"TAUNT": [
